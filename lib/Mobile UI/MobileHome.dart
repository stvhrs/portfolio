...
import 'package:portofolio/smooth.dart';
    ...
    return Scaffold(
        ...
        body: LayoutBuilder (
         builder: (BuildContext _, BoxConstraints constraints) {
              return SmoothScroll(controller: 
                controller,
              
                child: ScrollConfiguration(
                  behavior: const CustomScrollBehaviour(),
                  child: SingleChildScrollView(
                    physics:constraints.maxWidth > 1200.0? const NeverScrollableScrollPhysics():AlwaysScrollableScrollPhysics(),
